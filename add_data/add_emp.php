<?php
	...
	$sql = "INSERT INTO employee(dep_id,rank_id,emp_name_title,emp_fname,emp_lname,emp_gender,emp_address,emp_idcard,emp_nationality,emp_tel,emp_birthday,emp_account,emp_edu,emp_socialsecurity,emp_firstdaywork,emp_salary)
			VALUES('$department_id','$rank_id','$Mr_Mrs','$fname','$lname','$gender','$address','$pe_id','$nat_id','$phone_id','$date','$account','$eduction','$social_se','$fday','$salary')";
